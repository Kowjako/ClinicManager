    ...
    public partial class Schedule : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            scheduleChart.Series["SeriesData"].Points.AddXY("Poniedziałek",
                                                            regs.Where(p => ((p.Date.Value <= endDate.Value && p.Date.Value >= startDate.Value)
                                                            && p.Date.Value.DayOfWeek == DayOfWeek.Monday)).Count());
            ...
            scheduleChart.Series["SeriesData"].Points.AddXY("Wtorek",
                                                            regs.Where(p => ((p.Date.Value <= endDate.Value && p.Date.Value >= startDate.Value)
                                                            && p.Date.Value.DayOfWeek == DayOfWeek.Tuesday)).Count());
            ...
            scheduleChart.Series["SeriesData"].Points.AddXY("Środa",
                                                            regs.Where(p => ((p.Date.Value <= endDate.Value && p.Date.Value >= startDate.Value)
                                                            && p.Date.Value.DayOfWeek == DayOfWeek.Wednesday)).Count());
            ...
            scheduleChart.Series["SeriesData"].Points.AddXY("Czwartek",
                                                            regs.Where(p => ((p.Date.Value <= endDate.Value && p.Date.Value >= startDate.Value)
                                                            && p.Date.Value.DayOfWeek == DayOfWeek.Thursday)).Count());
            ...
            scheduleChart.Series["SeriesData"].Points.AddXY("Piątek",
                                                            regs.Where(p => ((p.Date.Value <= endDate.Value && p.Date.Value >= startDate.Value)
                                                            && p.Date.Value.DayOfWeek == DayOfWeek.Friday)).Count());
            ...
            scheduleChart.Series["SeriesData"].Points.AddXY("Sobota",
                                                            regs.Where(p => ((p.Date.Value <= endDate.Value && p.Date.Value >= startDate.Value)
                                                            && p.Date.Value.DayOfWeek == DayOfWeek.Saturday)).Count());
