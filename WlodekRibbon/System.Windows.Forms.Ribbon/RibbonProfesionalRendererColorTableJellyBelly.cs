...
// Type: System.Windows.Forms.RibbonProfesionalRendererColorTableJellyBelly
...
namespace System.Windows.Forms
{
  public class RibbonProfesionalRendererColorTableJellyBelly : RibbonProfesionalRendererColorTable
  {
    public RibbonProfesionalRendererColorTableJellyBelly()
    {
      ...
      this.TabSelectedBorder = this.FromHex("#B1B1B1");
      ...
      this.ButtonCheckedSelectedBgOut = this.FromHex("#0B4956");
      this.ButtonCheckedSelectedBgCenter = this.FromHex("#0B4956");
      this.ButtonCheckedSelectedBorderOut = this.FromHex("#3A8DB5");
      this.ButtonCheckedSelectedBorderIn = this.FromHex("#3A8DB5");
      this.ButtonCheckedSelectedGlossyNorth = this.FromHex("#0B4956");
      this.ButtonCheckedSelectedGlossySouth = this.FromHex("#0B4956");
      ...
      this.QATSeparatorLight = this.FromHex("#FAFBFD");
      this.QATSeparatorDark = this.FromHex("#484848");
      ...
      this.ButtonChecked_2013 = this.FromHex("#92C0E0");
